...
using DomainLayer;
using DomainLayer.Models.Shippings;
...
namespace DashboardMVCGraduation.Controllers
{
    public class ShippingsController : Controller
    {
        ...
        public ShippingsController(EcommerceDbContext context)
        {
            _context = context;
        }
        ...
        {
            var ecommerceDbContext = _context.Shippings.Include(s => s.Cart);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EcommerceDbContext.Shippings'  is null.");
            }
            var shipping = await _context.Shippings.FindAsync(id);
            if (shipping != null)
            {
