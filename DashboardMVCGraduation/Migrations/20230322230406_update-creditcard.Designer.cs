...
namespace DashboardMVCGraduation.Migrations
{
    ...
    [Migration("20230322230406_update-creditcard")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainLayer.Models.MasterCards.MasterCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.Models.PaymentMathods.PaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DomainLayer.Models.Carts.Cart", b =>
                {
                    ...
                    b.HasOne("DomainLayer.Models.PaymentMathods.PaymentMethod", "PaymentMethod")
                        .WithMany("Carts")
            ...
            modelBuilder.Entity("DomainLayer.Models.Customers.Customer", b =>
                {
                    b.HasOne("DomainLayer.Models.MasterCards.MasterCard", "MasterCard")
                        .WithMany("Customer")
            ...
            modelBuilder.Entity("DomainLayer.Models.MasterCards.MasterCard", b =>
                {
                    b.HasOne("DomainLayer.Models.PaymentMathods.PaymentMethod", null)
                        .WithMany("MasterCard")
                        .HasForeignKey("PaymentMethodId");
                });
